          ...
          <div className="bg-card rounded-lg shadow-soft p-6">
            ...
            {!loadingHistorial && historial.length > 0 && (
              <div className="grid grid-cols-2 gap-3 mb-4 sm:flex sm:flex-wrap">
                ...
                <select value={fSalon} onChange={(e) => setFSalon(e.target.value)} className="w-full sm:w-auto min-w-0 pl-2 pr-1 sm:px-3 py-2 border border-input rounded-md text-[13px] sm:text-sm bg-background cursor-pointer">
