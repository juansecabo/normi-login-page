...
// para que cada colegio vea solo sus grados ("Párvulo" existe en el
...
const EnviarComunicadoAdmin = () => {
  ...
  // Cargar las 4 listas de internos (Coord/Admin/Secre/Orientador)
  useEffect(() => {
    const necesitaLista =
  ...
  const handleEnviar = async () => {
    ...
    try {
      ...
      // Agrupar internos al máximo. Profesores en segmento propio solo si
      // tiene filtros de aula sin ids; el resto se combinan.
      ...
      // ApiError tiene el body en .body, no en .message. Revisar ambos para
      // detectar el caso 'no_destinatarios' (filtro vacio, no error sistema).
