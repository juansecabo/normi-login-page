...
const Formatos = () => {
  ...
  const formatosPesta: Formato[] = [
    ...
    { id: "apoyo", titulo: "Plan de Apoyo al Mejoramiento", desc: "Taller 40% + Sustentación 60%; definitiva máximo la nota aprobatoria y nunca menor que la anterior.", icon: CalendarClock, ruta: "/formatos/apoyo", listo: true },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-card rounded-lg shadow-soft p-6">
          <h1 className="text-center text-xl font-bold text-foreground">Formatos</h1>
