...
const DashboardAdmin = () => {
  ...
  const items: ReordItem[] = [
    { id: 'notas', render: <Card bg="bg-emerald-100 hover:bg-emerald-200" icon={<img src={iconNotas} alt="" className="w-16 h-16 object-contain" />} label="Notas" onClick={() => navigate("/dashboard/seleccionar-grado")} /> },
    { id: 'estadisticas', render: <Card bg="bg-green-100 hover:bg-green-200" icon={<img src={iconEstadisticas} alt="" className="w-16 h-16 object-contain" />} label="Estadísticas" onClick={() => navigate("/dashboard/estadisticas")} /> },
    ...
    { id: 'panel-control', render: <Card bg="bg-purple-100 hover:bg-purple-200" icon={<img src={iconPanelControl} alt="" className="w-16 h-16 object-contain" />} label="Panel de Control" onClick={() => navigate("/dashboard/panel-control")} /> },
    ...
    { id: 'uso-normi', render: <Card bg="bg-orange-100 hover:bg-orange-200" icon={<img src={iconUsoAgente} alt="" className="w-16 h-16 object-contain" />} label="Uso de Normi" onClick={() => navigate("/dashboard/uso-normi")} /> },
