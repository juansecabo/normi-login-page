...
const DashboardAdmin = () => {
  ...
  const items: ReordItem[] = [
    ...
    { id: 'boletines', render: <Card bg="bg-emerald-100 hover:bg-emerald-200" icon={<img src={iconDocumentos} alt="" className="w-16 h-16 object-contain" />} label="Boletines" onClick={() => navigate("/boletines")} /> },
