...
const DashboardAdmin = () => {
  ...
  const items: ReordItem[] = [
    ...
    ...(getSession().colegio_id === "2f96f076-83df-4b84-8bbc-9c1df79a372b" ? [{ id: 'observador', render: <Card bg="bg-sky-100 hover:bg-sky-200" icon={<img src={iconObservador} alt="" className="w-16 h-16 object-contain" />} label="Observador Estudiantil" onClick={() => navigate("/observador-estudiantil")} /> }] : []),
