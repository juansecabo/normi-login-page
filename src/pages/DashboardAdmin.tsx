...
const DashboardAdmin = () => {
  ...
  const items: ReordItem[] = [
    ...
    { id: 'permisos-excusas', badge: permisosTotal, render: <Card bg="bg-rose-100 hover:bg-rose-200" badge={permisosTotal} icon={<img src={iconPermisos} alt="" className="w-16 h-16 object-contain" />} label="Permisos y Excusas" onClick={() => navigate("/permisos-excusas")} /> },
    { id: 'solicitud-entrevista', badge: badges.entrevista, render: <Card bg="bg-indigo-100 hover:bg-indigo-200" badge={badges.entrevista} icon={<img src={iconEntrevista} alt="" className="w-16 h-16 object-contain" />} label="Solicitud de Entrevista" onClick={() => navigate("/solicitud-entrevista-staff")} /> },
    ...
    { id: 'porteria', render: <Card bg="bg-orange-100 hover:bg-orange-200" icon={<img src={iconPorteria} alt="" className="w-16 h-16 object-contain" />} label={nombreFicha("Portería")} onClick={() => navigate("/porteria")} /> },
