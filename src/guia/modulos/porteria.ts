...
export const PORTERIA: Capacidad[] = [
  ...
  },
  {
    ...
    descripcion:
      "Marcar a los estudiantes que llegaron tarde y enviar el reporte, que notifica por WhatsApp a sus acudientes con la hora de entrada (en un nivel sin acudientes se avisa solo al coordinador del nivel).",
    categoria: "Portería",
    roles: [...PORTERIA_ROLES],
    ...
    pasos: [
      ...
      {
        narracion:
          "Cuando estén todos, toca 'Enviar reporte'. Se notificará por WhatsApp a los acudientes con la hora de entrada de este momento (si el estudiante es de un nivel sin acudientes, se avisa solo al coordinador del nivel).",
        accion: "click",
