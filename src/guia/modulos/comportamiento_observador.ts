...
export const COMPORTAMIENTO_OBSERVADOR: Capacidad[] = [
  ...
  },
  {
    ...
    descripcion:
      "Escribir una nueva observación en el cuaderno de un estudiante; al guardarla se notifica por WhatsApp a sus acudientes (en un nivel sin acudientes no se envía aviso).",
    categoria: "Comportamiento y Observador",
    roles: [...INTERNOS_OBSERVADOR],
    ruta: "/observador-estudiantil",
    endpoint:
    ...
    pasos: [
      ...
      {
        narracion:
          "Toca 'Guardar'. Se avisa por WhatsApp a los acudientes del estudiante (si es de un nivel sin acudientes, no se envía aviso). Listo.",
        accion: "click",
  ...
  },
  {
    ...
    descripcion:
      "Escribir una observación una sola vez y guardarla para varios estudiantes a la vez (incluso de distintos salones); notifica a los acudientes de cada uno (salvo los de niveles sin acudientes).",
    categoria: "Comportamiento y Observador",
    roles: [...INTERNOS_OBSERVADOR],
    ruta: "/observador-estudiantil",
    endpoint:
