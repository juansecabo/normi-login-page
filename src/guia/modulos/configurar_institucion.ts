...
export const CONFIGURAR_INSTITUCION: Capacidad[] = [
  ...
  },
  {
    ...
    descripcion: "Pintar en el calendario un día o rango sin clases, escoger si es para todo el colegio o para un nivel, y ponerle motivo (los avisos no se envían esos días a quienes aplica).",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
    ...
    pasos: [
      ...
      { narracion: "En 'Para quién es', deja 'Todo el colegio' o escoge el nivel que no tiene clases.", accion: "click", ancla: "configurar_institucion.cal_dia_alcance", opcional: true },
  ...
  },
  {
    ...
    pasos: [
      ...
      { narracion: "En un evento, abajo puedes cambiar para quién es (todo el colegio, o los niveles, grados o salones que marques).", accion: "click", ancla: "configurar_institucion.cal_evento_alcance", opcional: true },
