...
export const CONFIGURAR_INSTITUCION: Capacidad[] = [
  ...
  // ─────────────────────────── ESCALA ───────────────────────────
  {
    ...
    pasos: [
      ...
      { narracion: "Toca la ficha 'Rango' (o 'Aprueba con') para abrir la escala.", accion: "click", ancla: "configurar_institucion.escala_rango" },
      ...
      { narracion: "Escribe con cuánto se aprueba (dentro de la escala).", accion: "escribir", ancla: "configurar_institucion.escala_aprobatoria", campo: "nota_aprobatoria" },
  ...
  },
  {
    ...
    pasos: [
      ...abrirFicha("escala", "Abrimos Escala de calificación."),
      { narracion: "Toca 'Agregar rango', debajo de las fichas de los rangos.", accion: "click", ancla: "configurar_institucion.escala_agregar_rango" },
      ...
      { narracion: "Pon el Desde y el Hasta del rango. Los rangos de al lado se ajustan solos.", accion: "escribir", ancla: "configurar_institucion.rango_desde", campo: "rango_min_max" },
  ...
  {
    id: "configurar_institucion.editar_rango_desempeno",
    titulo: "Cambiar o quitar un rango de desempeño",
    descripcion: "Cambiar el nombre, las notas (desde y hasta) o el color de un rango, o quitarlo. Al cambiar las notas, los rangos de al lado se ajustan solos según los decimales (si uno queda hasta 4.5, el siguiente empieza en 4.6). Si se quita, sus notas pasan al rango vecino.",
    categoria: "Configurar Institución",
    roles: [...CONFIG_COLEGIO],
    ruta: RUTA,
    endpoint: "PATCH /api/colegio/config (rangos_desempeno)",
    sinonimos: [
      "cambiar un rango de desempeño",
      "editar el rango superior",
      "cambiar hasta dónde va básico",
      "cambiar el nombre de un rango",
      "quitar un rango de desempeño",
      "cambiar el color de un rango",
    ],
    pasos: [
      ...abrirFicha("escala", "Abrimos Escala de calificación."),
      { narracion: "Toca la ficha del rango que quieres cambiar.", accion: "click", ancla: "configurar_institucion.rango_ficha" },
      { narracion: "Cambia el nombre, el Desde, el Hasta o el color (o toca 'Quitar'). Los rangos de al lado se ajustan solos.", accion: "escribir", ancla: "configurar_institucion.rango_desde", campo: "rango_min_max" },
      { narracion: "Toca 'Guardar'.", accion: "click", ancla: "configurar_institucion.rango_guardar" },
    ],
  },
  ...
  {
    id: "configurar_institucion.esquema_nivel",
    titulo: "Elegir si un nivel se evalúa por periodos o por semestres",
    descripcion: "Cada nivel puede calificarse por periodos (cuatro cortes al año y definitiva anual) o por semestres (dos cortes al año, cada uno con su propia definitiva). Ejemplo: Formación Complementaria por semestres mientras el resto del colegio va por periodos. Cambia las tablas de notas, los consolidados, los boletines y las fechas del calendario de ese nivel.",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
    endpoint: "PATCH /api/institucion/niveles/:id (esquema)",
    sinonimos: [
      "poner un nivel por semestres",
      "evaluar por semestres",
      "cambiar de periodos a semestres",
      "esquema de evaluación del nivel",
      "formación complementaria por semestres",
      "cuántos periodos tiene un nivel",
      "dos cortes al año",
    ],
    pasos: [
      ...abrirFicha("estructura", "Abrimos Jornadas, grados y salones."),
      { narracion: "Baja al recuadro 'Esquema de evaluación por nivel'. Hay una fila por cada nivel del colegio.", accion: "click", ancla: "configurar_institucion.nivel_esquema" },
      { narracion: "En la fila del nivel, abre la lista y elige 'Periodos (4 cortes)' o 'Semestres (2 cortes)'. Se guarda solo y las notas de ese nivel pasan a mostrarse con ese esquema.", accion: "click", ancla: "configurar_institucion.nivel_esquema_select", campo: "esquema" },
    ],
  },
  {
    ...
    roles: ["rector", "admin"],
    ruta: RUTA,
    endpoint: "PATCH /api/institucion/niveles/:id (adultos)",
    sinonimos: [
      "estudiantes adultos",
      "nivel sin acudientes",
      "quitar acudientes de un nivel",
      "formación complementaria sin acudientes",
      "universidad sin padres de familia",
      "los estudiantes son mayores de edad",
    ],
    pasos: [
      ...abrirFicha("estructura", "Abrimos Jornadas, grados y salones."),
  ...
  },
  {
    ...
    descripcion: "Cada asignatura tiene su propio color en la institución, sacado al azar del círculo de colores; ninguna otra asignatura del colegio tiene el mismo código. Se pinta así en todos los horarios. Aquí se puede escoger otro con el círculo, escribiendo el código o con 'Otro al azar'; un código exacto que ya tenga otra asignatura no se deja escoger.",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
    ...
    pasos: [
      ...
      { narracion: "Toca o arrastra en el círculo de colores (o escribe el código, o toca 'Otro al azar'); al lado ves cómo se verá.", accion: "click", ancla: "configurar_institucion.asignatura_color_circulo", campo: "color" },
  ...
  // ─────────────────── CALENDARIO ───────────────────
  {
    ...
    descripcion: "Pintar en el calendario las fechas de un periodo (1 a 4) arrastrando del día inicial al final. Hay un solo calendario: los periodos son los mismos para todos los niveles, y los semestres (si algún nivel va por semestres) los mismos para todos esos niveles. Rector, administrador y coordinadores lo editan por igual.",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
  ...
  },
  {
    ...
    descripcion: "Pintar en el calendario un día o rango sin clases, ponerle motivo y escoger si es para todo el colegio o solo para los niveles, grados o salones que se marquen (los avisos no se envían esos días a quienes aplica).",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
    ...
    pasos: [
      ...
      { narracion: "En 'Para quién es', deja 'Todo el colegio' o toca 'Escoger niveles, grados o salones' y marca los que no tienen clases. La flechita al lado de un nivel muestra sus grados, y la de un grado, sus salones.", accion: "click", ancla: "configurar_institucion.cal_dia_alcance", opcional: true },
  ...
  },
  {
    ...
    descripcion: "Marcar un día CON clases donde además pasa algo (entrega de boletines, día deportivo, izada de bandera), para todo el colegio o solo para los niveles, grados o salones que se escojan (por ejemplo, la clausura de Sexto a Décimo). Solo lo ven y reciben el aviso las personas de lo escogido. Un evento no indica si hay o no clases: puede caer en un día normal o en uno marcado sin clases.",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
    ...
    sinonimos: [
      ...
      "evento solo para un grado",
      "evento para ciertos salones",
      "evento de sexto a décimo",
    ],
    pasos: [
      ...abrirFicha("calendario", "Abrimos el Calendario."),
      ...
      { narracion: "En 'Para quién es', deja 'Todo el colegio' o toca 'Escoger niveles, grados o salones' y marca los que son. La flechita al lado de un nivel muestra sus grados, y la de un grado, sus salones.", accion: "click", ancla: "configurar_institucion.cal_evento_alcance", campo: "alcance", opcional: true },
  ...
  },
  {
    ...
    descripcion: "Sin herramienta activa, tocar un día pintado para ver su detalle y editar su motivo, o el nombre de un evento y para quién es.",
    categoria: "Configurar Institución",
    roles: [...EDITAN_ESTRUCTURA],
    ruta: RUTA,
    ...
    sinonimos: [
      ...
      "cambiar para qué grados es un evento",
      "cambiar para qué grados es un día sin clases",
    ...
    pasos: [
      ...
      { narracion: "Abajo puedes cambiar para quién es (todo el colegio, o los niveles, grados o salones que marques).", accion: "click", ancla: "configurar_institucion.cal_evento_alcance", opcional: true },
