...
export const ORIENTACION: Capacidad[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      {
        narracion:
          "En 'Informar a', marca a quién se le avisa: al estudiante, a los acudientes, o a ambos (en un nivel sin acudientes solo aparece el estudiante). Es obligatorio elegir al menos uno.",
        accion: "click",
